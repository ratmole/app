var feed = {
        ...
        $.ajax({                                      
            ...
            success: function(result) {
                if (!result || result===null || result==="" || result.constructor!=Array) {
                    app.log("ERROR","feed.listbyidasync invalid response: "+result);
                }
                feeds = result; 
    ...
    list: function()
    {
        ...
        $.ajax({                                      
            ...
            success: function(result) {
                if (!result || result===null || result==="" || result.constructor!=Array) {
                    app.log("ERROR","feed.list invalid response: "+result);
                }
                feeds = result; 
            } 
        });
    ...
    getdata: function(id,start,end,interval,skipmissing,limitinterval)
    {
        ...
        $.ajax({                                      
            ...
            success: function(result) {
                if (!result || result===null || result==="" || result.constructor!=Array) {
                    app.log("ERROR","feed.getdata invalid response: "+result);
                }
    ...
    getdataDMY: function(id,start,end,mode)
    {
        ...
        $.ajax({                                      
            ...
            success: function(result) {
                if (!result || result===null || result==="" || result.constructor!=Array) {
                    app.log("ERROR","feed.getdataDMY invalid response: "+result);
                }
        ...
        $.ajax({                                      
            ...
            success: function(result) {
                if (!result || result===null || result==="" || result.constructor!=Object) {
                    app.log("ERROR","feed.getmeta invalid response: "+result);
                }
                meta = result; 
            } 
        });
    ...
    {   
        ...
        $.ajax({                                      
            ...
            success: function(result) {
                if (!result || result===null || result==="" || result.constructor!=Array) {
                    app.log("ERROR","feed.getdataremote invalid response: "+result);
                    result = [];
                }
                data = result;
            }
    ...
    {   
        ...
        $.ajax({                                      
            ...
            success: function(result) {
                if (isNaN(result)) {
                    app.log("ERROR","feed.getvalueremote value is not a number, found: "+result);
                    result = 0;
                }
